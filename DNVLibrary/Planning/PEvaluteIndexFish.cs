...
namespace DNVLibrary.Planning
{
    ...
    class PEvaluteIndexFish : AppBase
    {
        public PEvaluteIndexFish(UCDNV863 Root)
            : base(Root)
        {
        ...
        internal override void load()
        {
            ...
            curcontrol = new FishBone.UserControl1();
            root.grdContent.Children.Add(curcontrol);

            MyBaseControls.StatusBarTool.StatusBarTool.tipsInfo.curDomain = "规划_指标_鱼骨图";

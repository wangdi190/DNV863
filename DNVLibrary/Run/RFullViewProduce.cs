...
namespace DNVLibrary.Run
{
    ...
    class RFullViewProduce : AppBase
    {
        public RFullViewProduce(UCDNV863 Root)
            : base(Root)
        {
        ...
        RFullViewProduceCount curcontrol;
        internal override void load()
        {
            ...
            curcontrol = new RFullViewProduceCount() { Margin = new System.Windows.Thickness(20, 100, 20, 20) };

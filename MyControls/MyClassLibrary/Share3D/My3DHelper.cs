...
namespace MyClassLibrary.Share3D
{
    ...
    public static class My3DHelper
    {
        ...
        /// <returns>材质</returns>
        public static Brush getSolidBrush(EMaterailColor color, EMaterialColorDeep deep)
        {
            Brush brush;
            ...
            brush = (Brush)Application.Current.FindResource(resname);
            return brush;
        }
        /// <summary>
        /// 获取画刷资源键名称
        ...
        /// <param name="deep">深度</param>
        /// <returns>材质</returns>
        public static string getSolidBrushKey(EMaterailColor color, EMaterialColorDeep deep)
        {
            string resname = "color";
            switch (deep)
            {
        ...
        /// <param name="deep">深度</param>
        /// <returns>材质</returns>
        public static string getSolidMaterialKey(EMaterailColor color, EMaterialColorDeep deep)
        {
            string resname = "mat";
            switch (deep)
            {
        ...
        {
            string keyname = getSolidMaterialKey(color, deep);
            Material mat;
            mat = (Material)Application.Current.FindResource(keyname);
            return mat;
        }
